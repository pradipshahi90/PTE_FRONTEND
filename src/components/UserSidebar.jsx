...
const navItems = [
    ...
    { label: 'Users', href: '/user/users', icon: Users },
    { label: 'Reading Materials', href: '/user/reading-materials', icon: BookOpen },
];
...
export default function UserSidebar() {
    ...
    return (
        <>
            ...
            >
                <h2 className="text-2xl font-bold mt-4 md:mt-0 mb-8 text-blue-700">User Panel</h2>
